...
This repository implements a simple controller for watching Zap resources as
defined with a CustomResourceDefinition (CRD).

**Note:** go-get or vendor this package as `github.com/dzou-hpe/kubesecops`.

This particular example demonstrates how to perform basic operations such as:

* How to register a new custom resource (custom resource type) of type `Zap` using a CustomResourceDefinition.
* How to create/get/list instances of your new resource type `Zap`.
...
```sh
go get -d github.com/dzou-hpe/kubesecops
cd $GOPATH/src/github.com/dzou-hpe/kubesecops
godep restore
```
...
`kubernetes/staging/src/github.com/dzou-hpe/kubesecops` and its dependencies
...
kubectl create -f artifacts/examples/example-zap.yaml
...
```sh
kubectl delete crd zaps.kubesecops.io
```
...
https://github.com/kubernetes/kubernetes/blob/master/staging/src/github.com/dzou-hpe/kubesecops.
